...
{
    [ReactNode]
    public class FastMutatingSelector : BranchNode
    {
        [ReactVar("Mutation")]
        ...
        {
            return "FastMutatingSelector";
        }
#if UNITY_EDITOR
        public new static string GetHelpText ()
        {
            return "Just like a normal selector, except that the first child that succeeds is also moved into first or last place. Doesn't wait.";
        }			
#endif		
    }
